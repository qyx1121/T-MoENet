...
def build_mc_dataset(dataset_name, split, args, tokenizer):
    ...
    if dataset_name == "nextqa":
        if split == "train":
            ...
            csv_path = args.nextqa_val_csv_path  # eval on val public
        else:
            raise NotImplementedError
        features_path = args.nextqa_features_path

    elif dataset_name == "starqa":
        if split == "train":
            csv_path = args.starqa_train_csv_path
        elif split == "val":
            csv_path = args.starqa_val_csv_path
        elif split == "test":
            csv_path = args.starqa_test_csv_path
        else:
            raise NotImplementedError
        features_path = args.starqa_features_path
    else:
        raise NotImplementedError
    return MC_Dataset(
        csv_path=csv_path,
